...
class DataPath:
    ...
    def __init__(self, data_memory_size, input_buffer_begin, output_buffer_begin):
...
class ControlUnit:
    ...
    def decode_and_execute_instruction(self):
        ...
        match opcode:
            ...
            case Opcode.PRINT | Opcode.FORMAT:
...
def simulation(code, input_buffer_begin, output_buffer_begin, data_memory_size, limit):
    ...
    """
    data_path = DataPath(data_memory_size, input_buffer_begin=input_buffer_begin,
                         output_buffer_begin=output_buffer_begin)
